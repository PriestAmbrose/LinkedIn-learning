...
const createForm = function() {
  ...
  element.innerHTML = `<input type="text" id="name" name="user_name">`
  return element;
}
...
const backpackList = backpackObjectArray.map((backpack) => {
  ...
  debugger;
  const strapList = backpackArticle.getElementsByClassName("feature backpack__strap");
  for (const strap of strapList){
